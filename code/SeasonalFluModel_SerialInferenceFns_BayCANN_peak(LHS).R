...
SampleFirstGenFn_FourSeasonFit <- function(N){
  ...
  d = matrix(c(0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, #Transmissibility
       0,1, 0,1, 0,1, #Immunity propagation params
       0,0.05 ,0,0.05 ,0,0.05 ,0,0.05), ncol=2, byrow = TRUE) #Strain modifier for susceptibility
...
SampleFirstGenFn_FiveSeasonFit <-function(N){
  ...
  d = matrix(c(0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, #Transmissibility
               0,1, 0,1, 0,1, #Immunity propagation params
               0,0.05 ,0,0.05 ,0,0.05 ,0,0.05, 0,0.05), ncol=2, byrow = TRUE) #Strain modifier for susceptibility
...
#Distributions to be sampled from for each variable
  d = matrix(c(0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, 0.2632,3*0.2632, #Transmissibility
               0,1, 0,1, 0,1, #Immunity propagation params
               0,0.05 ,0,0.05 ,0,0.05 ,0,0.05, 0,0.05, 0,0.05), ncol=2, byrow = TRUE) #Strain modifier for susceptibility
