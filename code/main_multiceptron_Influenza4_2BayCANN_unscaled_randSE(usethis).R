...
png(filename='output/ann_convergence_influenza_2targ_continuous(6lys).png')
plot(history)
dev.off()

# plot ANN validation
model %>% evaluate(x_test, y_test)
png(filename='output/ann_validation_vs_observed_influenza_2targ_continuous(6lys).png')
...
png(filename='output/ann_fit_vs_observed_influenza_2targ_continuous(6lys).png')
...
png(filename='output/ann_fit_vs_observed_influenza_2targ_continuous(unscaled)(6lys).png')
par("mar", mfrow = c(4,5), mar=c(1,1,1,1))
for (o in 1:n_outputs){
