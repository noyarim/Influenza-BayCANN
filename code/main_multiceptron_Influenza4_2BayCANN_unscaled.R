# Code last updated on: 2021. 02.27
# Original code: main_multiceptron_Influenza4_2BayCANN.R
# Change made: 
# (1) ANN is still fit on scaled of log-tranformed data (x,y)
# (2) in BayCANN, we unscale the ANN's predicted outcome and exponentiated back to natural scale so that we don't ignore the fit to targets with large scale.
...
s0 <- stan(file = "code/post_multi_perceptron_influenza_peak_unscale.stan", data = stan.dat, iter = n_iter, chains = n_chains, 
